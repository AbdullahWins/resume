...
**Live Demo/Links:**    
- [Teacher App (Google Play)](https://play.google.com/store/apps/details?id=com.smartpathshala.teacher&pcampaignid=web_share)   
- [Head Teacher App (Google Play)](https://play.google.com/store/apps/details?id=com.smartpathshala.headteacher&pcampaignid=web_share)
- Guardian App (coming soon)
...
**Live Demo/Links:**  
- [Android App (Google Play)](https://play.google.com/store/apps/details?id=com.netrosystems.rimozen&pcampaignid=web_share)  
- Admin Panel (private)
...
_Node.js, Express.js, MongoDB, Socket.io, OpenAI, LangChain, Vector DB, Stripe, Docker, Grafana, Prometheus_  
- Developed SEO friendly, engaging and tailored contents powered by OpenAI generative models.
...
**Live Demo/Links:**  
- [Android App (Google Play)](https://play.google.com/store/apps/details?id=com.atti.atti)  
- [iOS App (App Store)](https://apps.apple.com/us/app/atti/id6661021480)  
- Admin Panel (private) 
...
**Live Demo/Links:**  
- [Android App (Google Play)](https://play.google.com/store/apps/details?id=com.netrocreative.jazakallah&pcampaignid=web_share)  
...
- Delivered custom systems for rent management with robust data security, Google OAuth, Redis, Prometheus, Grafana.  
**Live Demo/Links:**  
- Admin Panel (private)
- EMS Module (private)
...
**LinkPin (Chrome Web Extension)**  
_ReactJS_  
- Developed and published a Chrome browser extension for saving and organizing web links.  
- [View on Chrome Web Store](https://chromewebstore.google.com/detail/hfchehpghclhhkpdinniknekabegchhb?utm_source=item-share-cb)
...
_Unity_  
- Designed and published a mobile action-puzzle game on Google Play Store.  
- [Play on Google Play](https://play.google.com/store/apps/details?id=com.NADES.CatasTrophe&pcampaignid=web_share)
